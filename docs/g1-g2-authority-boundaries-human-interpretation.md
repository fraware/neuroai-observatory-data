...
Interpretation rule: treat any `"UNKNOWN"` fields as unresolved. Do not guess workbench lineage, commits, run IDs, or candidate descriptors. Replace UNKNOWN placeholders only after externally verified public governance/provenance material is recorded.
