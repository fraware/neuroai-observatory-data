...
class OperationalHealthTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.plan = {"counts": {"due": 10, "manual": 0, "not_due": 217}}
    ...
    def test_exact_current_state_is_healthy_with_clean_complete_run(self) -> None:
        ...
        self.assertEqual(report["registry"]["automatic_monitors"], 227)
    ...
    def test_internal_incomplete_or_slo_breach_is_unhealthy(self) -> None:
        ...
        self.assertEqual(
            codes,
            {"RUN_NOT_OPERATIONALLY_COMPLETE", "TARGET_EXECUTION_SLO_BREACH", "INCOMPLETE_SOURCE_OUTCOMES"},
        )

    def test_namespace_or_registry_drift_is_unhealthy(self) -> None:
        accountability = copy.deepcopy(self.accountability)
        accountability["current"]["effective_source_count"] = 247
        accountability["current"]["counts"]["GAP"] = 4
